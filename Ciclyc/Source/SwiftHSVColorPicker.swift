...
open class SwiftHSVColorPicker: UIView, ColorWheelDelegate, BrightnessViewDelegate {
    ...
    func setup() {
        ...
        colorWheel = ColorWheel(frame: CGRect(x: centeredX, y: selectedColorView.frame.maxY + offset, width: colorWheelSize, height: colorWheelSize), color: self.color)
        colorWheel.delegate = self
        // Add colorWheel as a subview of this view
        self.addSubview(colorWheel)
        
        // Init new BrightnessView subview
        brightnessView = BrightnessView(frame: CGRect(x: centeredX, y: colorWheel.frame.maxY + offset, width: colorWheelSize, height: brightnessViewHeight), color: self.color)
